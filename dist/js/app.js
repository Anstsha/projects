(() => {
    ...
    function initSliders() {
        if (document.querySelector(".new__slide")) new swiper_core_Swiper(".new__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".header-new-prev",
                nextEl: ".header-new-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".relevant__slide")) new swiper_core_Swiper(".relevant__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".header-relevant-prev",
                nextEl: ".header-relevant-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    da.init();
    document.addEventListener("click", (function(e) {
        if (e.target.closest(".icon-filter") || e.target.closest(".icon-close")) document.documentElement.classList.toggle("filter-open");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
